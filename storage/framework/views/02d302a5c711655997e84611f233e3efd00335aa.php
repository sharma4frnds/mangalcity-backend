...
<ul>
  <?php if($act->post->type=='image'): ?>
   <?php $cposts_img=''; if(isset($act->post->media[0])) $cposts_img=$act->post->media[0]->name; ?>
    <li><?php echo e(Html::image('public/images/post/post_image/'.$cposts_img,'img',array('class'=>'img-responsive'))); ?> </li>
  <?php endif; ?>
