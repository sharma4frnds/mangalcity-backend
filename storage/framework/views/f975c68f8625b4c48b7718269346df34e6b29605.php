                    ...
                    <?php echo Form::open(array('url' => 'admin/property/'.$property->id,'method' => 'PUT','class' => 'form-horizontal form-label-left','files' => true)); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                          ...
                          <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Property Id <span class="required">*</span>
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="property_id" name="property_id" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e($property->property_id); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="price" name="price" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e($property->price); ?>">
                        </div>
                      </div>
                       ...
                       <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Bedroom 
                        ...
                        <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">Bathroom <span class="required">*</span>
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="address" name="area"  class="form-control col-md-7 col-xs-12" value="<?php echo e($property->area); ?>">
                        </div>
                          <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">City
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="city" name="city"  class="form-control col-md-7 col-xs-12" value="<?php echo e($property->city); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="zip" name="zip"  class="form-control col-md-7 col-xs-12" value="<?php echo e($property->zip); ?>">
                        </div>
                          <label class="control-label col-md-2 col-sm-2 col-xs-12" for="first-name">State
                        </label>
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="state" name="state"  class="form-control col-md-7 col-xs-12" value="<?php echo e($property->state); ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12">
                          <input type="text" id="county" name="county"  class="form-control col-md-7 col-xs-12" value="<?php echo e($property->county); ?>">
                        </div>
                          <label for="first-name" class="control-label col-md-2 col-sm-2 col-xs-12">
