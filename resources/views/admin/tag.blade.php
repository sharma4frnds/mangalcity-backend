 ...
 <div class="right_col" role="main">
              ...
              <div class="title_right">
                <div class="col-md-2 col-sm-5 col-xs-12 form-group pull-right top_search">
                  <div class="input-group">
                     <a href={{url('admin/tags/create')}}> <button class="btn btn-primary" type="submit">Add Tag</button></a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <a class="btn btn-info btn-xs" href="{{ url("admin/tags/$row->id/edit") }}">Edit</a> 
