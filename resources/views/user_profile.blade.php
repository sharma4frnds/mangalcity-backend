            ...
            <section>
                 ...
                 {!! Form::open(array('url' => 'user/profile','method' => 'POST','class' => 'form-horizontal' )) !!}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control"  value="{{Auth::user()->mobile}}" readonly>
                              <div class="checkbox">
                                <label>
                                  <input id="mobile_hidden" name="mobile_hidden" type="checkbox" value="1" @if(Auth::user()->mobile_hidden==1) checked @endif>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" placeholder="profession" name="profession" required="" value="{{Auth::user()->profession}}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          ...
                          <div class="checkbox">
                          <label>
                            <input id="dob_hidden" name="dob_hidden" type="checkbox" value="1" @if(Auth::user()->dob_hidden==1) checked @endif>
